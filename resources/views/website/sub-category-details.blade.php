...
@section('maintitle') {{$sub_categories->sub_category_name}} @endsection
@section('mainwebsite')
<main>
<!-- breadcrumb-area -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-content">
                    <h2 class="title">{{$sub_categories->sub_category_name}}</h2>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('home.index')}}">Home</a></li>
                            {{-- <li class="breadcrumb-item"><a href="products.php">Products</a></li> --}}
                            <li class="breadcrumb-item active" aria-current="page">{{$sub_categories->sub_category_name}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-8">
                <div class="services-details-wrap">
                    <div class="gallery">
                        @if(!empty($sub_categories->images))
                        
                            @foreach(json_decode($sub_categories->images) as $imagePath) 
                    ...
                    <div class="services-details-content mt-2">
                        <!-- <h2 class="title">{{$sub_categories->title}}</h2> -->
                        <div class="geta-quote">
                            <div class="pricing-section">
                                <h3><span>Approx Price:  </span> ₹ {{$sub_categories->price}} {{$sub_categories->unit}}</h3>
                            </div>
                            <div class="quoteup">
                        ...
                        <div class="product-head mt-3">
                            <h4>{{$sub_categories->title}}</h4>
                            {!! $sub_categories->description !!}
                        </div>
                         <table class="table table-hover table-border mt-5" style="border:1px solid #eaeaea">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-12">
                                    <div class="services-process-content">
                                        ...
                                        <div class="row">
                                             @if(!empty($sub_categories->sub_category_id))
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="benefits-content">
                                        <h2 class="title">Our Service Benefits
                                        </h2>
                                    ...
                                    <ul class="list-wrap">
                                        @if (count($categoryGroup->sub_category) > 0)
                                            @foreach($categoryGroup->sub_category as $val)
                                                <li>
                                                    <a href="{{ route('home.product-sub-details', $val->sub_slug) }}">
                                                        {{ $val->productsubcategory }}
                                        ...
                                        @else
                                            <li>
                                                <a href="{{ route('home.product-details', $categoryGroup->slug) }}">
