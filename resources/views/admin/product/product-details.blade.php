      ...
      <div class="col-sm-12">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <a href="{{route('productcategories.create')}}" class="btn btn-primary ms-auto">Add Product Details</a>
              </div>
          <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-inline-flex gap-1">
                         <a href="{{route('productcategories.edit', ['productcategory' => $category->id])}}" class="btn btn-outline-success btn-sm">
