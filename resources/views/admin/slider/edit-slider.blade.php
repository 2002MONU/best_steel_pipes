              ...
              <div class="row gx-3">
                ...
                <div class="col-xxl-6 col-lg-6 col-sm-12">
                  <div class="mb-3">
                    ...
                    <textarea type="text" class="form-control ckeditor"  name="description" placeholder="Enter description ">{{$slider->description}}</textarea>
                    @error('description')
                    <div class="error text-danger">{{ $message }}</div>
                    @enderror 
                </div>
                ...
                <div class="col-xxl-6 col-lg-6 col-sm-6">
                  <div class="mb-3">
                    ...
                    <div class="error text-danger">{{ $message }}</div>
                    @enderror <br>
                    <a href="{{asset('assets/dynamics/slider/'.$slider->image)}}"><img src="{{asset('assets/dynamics/slider/'.$slider->image)}}" style="width:100px;height:100px;"></a>
